import { FileText, Receipt, FileCheck, FileX, Truck, CreditCard, RotateCcw } from "lucide-react";
            ...
            <table className="w-full border border-black" style={{ fontSize: '11px' }}>
              <thead className="bg-slate-100">
                <tr>
                  ...
                  <th className="border-r border-black p-2 text-left font-semibold">
                    {document.doc_type === 'return' ? 'N° de Retour' :
                      document.doc_type === 'credit_note' ? 'N° Note de Crédit' :
                        document.doc_type === 'quote' ? 'N° de Devis' :
                          document.doc_type === 'delivery_note' ? 'N° de Livraison' : 'N° de Facture'}
                  </th>
                  <th className="border-r border-black p-2 text-left font-semibold">
                    {document.doc_type === 'return' ? "Facture d'origine" : "Référence"}
                  </th>
              ...
              <tbody>
                <tr>
                  ...
                  <td className="border-r border-black p-2">
                    {document.doc_type === 'return' && document.invoice_number
